...
#[derive(Debug)]
pub struct HiveCompassProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HiveCompassProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HiveCompass processing");
    
    let mut processor = HiveCompassProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HiveCompassProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HiveCompassProcessor::new(false);
